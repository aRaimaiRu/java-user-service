...
import static com.eshop.service.userservice.handler.BusinessErrorCodes.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleException(TokenNotFoundException exp) {
        return ResponseEntity
                .status(BAD_REQUEST)
                .body(
                        ExceptionResponse.builder()
